...
\caption{Placeholder: CER and WER comparison across all systems.}
\label{fig:cer_wer_all}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\rule{0pt}{2.0in}\rule{0.92\linewidth}{0pt}}
\caption{Placeholder: Accuracy--speed trade-off (RTF vs WER) for all systems.}
\label{fig:rtf_wer_tradeoff}
\end{figure}
...
\begin{table}[H]
\centering
\caption{Qualitative transcription examples (reference vs hypotheses).}
...
\hline
Reference & \texttt{<fill: reference sentence>} \\
Kaldi (tri3) & \texttt{<fill: hypothesis>} \\
CRDNN--CTC (best) & \texttt{<fill: hypothesis>} \\
Whisper (best) & \texttt{<fill: hypothesis>} \\
\hline
\end{tabular}}
\end{table}
